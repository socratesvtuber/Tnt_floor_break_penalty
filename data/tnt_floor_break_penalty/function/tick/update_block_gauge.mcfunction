...
# 表示テキストを更新
bossbar set minecraft:block_gauge name [{"text":"ブロックゲージ: "},{"score":{"name":"#block_percent","objective":"penalty"},"color":"aqua"},{"text":"% （"},{"score":{"name":"#filled","objective":"penalty"},"color":"gold"},{"text":" / "},{"score":{"name":"#max_space","objective":"penalty"},"color":"gold"},{"text":"）"}]
